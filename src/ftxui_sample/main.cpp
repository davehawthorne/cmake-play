...
// configuration step. It creates a namespace called `cmake_play`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_play::cmake::project_name, cmake_play::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_play::cmake::project_version);
      return EXIT_SUCCESS;
    }
